...
$day_start_universe = date("d", $hofrc_config["start_universe"]);
$month_start_universe = date("m", $hofrc_config["start_universe"]);
$year_start_universe = date("Y", $hofrc_config["start_universe"]);
